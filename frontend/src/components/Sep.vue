<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-title v-if="value._links">
            Sep # {{value._links.self.href.split("/")[value._links.self.href.split("/").length - 1]}}
        </v-card-title >
        <v-card-title v-else>
            Sep
        </v-card-title >
...
<script>
    ...
    export default {
        ...
        created(){
            ...
            websocketUrl.pathname = "/rsocket/seps";
            websocketUrl.hash = "";
            ...
            client.connect().subscribe({
                ...
                const endpoint = "seps."+ me.value.id +".get"
        ...
        methods: {
            ...
            async save(){
                try {
                    ...
                    if(!this.offline) {
                        if(this.isNew) {
                            temp = await axios.post(axios.fixUrl('/seps'), this.value)
                        } else {
