<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-title v-if="value._links">
            PowerGeneration # {{value._links.self.href.split("/")[value._links.self.href.split("/").length - 1]}}
        </v-card-title >
        <v-card-title v-else>
            PowerGeneration
        </v-card-title >
...
<script>
    ...
    export default {
        ...
        created(){
            ...
            websocketUrl.pathname = "/rsocket/powerGenerations";
            websocketUrl.hash = "";
        ...
        methods: {
            ...
            async save(){
                try {
                    ...
                    if(!this.offline) {
                        if(this.isNew) {
                            temp = await axios.post(axios.fixUrl('/powerGenerations'), this.value)
                        } else {
